...
export const account = pgTable(
	...
	(table) => [
		...
		index("account_userId_providerId_idx").on(
			table.userId,
			table.providerId,
		),
	],
...
export const agentHost = pgTable(
	...
	(table) => [
		...
		index("agentHost_enrollmentTokenHash_idx").on(
...
export const approvalRequest = pgTable(
	...
	(table) => [
		...
		index("approvalRequest_agentId_status_idx").on(
			table.agentId,
			table.status,
		),
		index("approvalRequest_userId_status_idx").on(
			table.userId,
			table.status,
		),
...
export const autonomousProjects = pgTable(
	...
	(table) => [
		uniqueIndex("autonomous_projects_hostId_projectId_idx").on(
			table.hostId,
			table.projectId,
		),
	],
