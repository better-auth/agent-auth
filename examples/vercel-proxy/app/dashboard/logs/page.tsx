                      ...
                      <div className="flex-1 min-w-0 flex items-center gap-3">
                        {log.agentId && (
                          <span className="text-xs text-muted truncate">
                            agent:{" "}
                            <code className="text-foreground/70">{log.agentId.slice(0, 8)}…</code>
                          </span>
                        )}
                        {log.hostId && (
                          <span className="text-xs text-muted truncate">
                            host:{" "}
                            <code className="text-foreground/70">{log.hostId.slice(0, 8)}…</code>
                          </span>
                        )}
                        {log.actorId && (
                          <span className="text-xs text-muted truncate">
                            by{" "}
                            <code className="text-foreground/70">{log.actorId.slice(0, 8)}…</code>
                          </span>
                        )}
                      </div>
