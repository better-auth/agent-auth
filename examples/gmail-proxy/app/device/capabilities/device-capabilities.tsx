      ...
      <div className="flex min-h-screen flex-col items-center justify-center bg-white">
        <main className="flex w-full max-w-[420px] flex-col items-center px-8 py-12">
          <div className="flex flex-col items-center gap-4 text-center">
            ...
            <h1 className="text-[22px] font-normal text-foreground">Sign in to continue</h1>
    ...
    return (
      <div className="flex min-h-screen flex-col items-center justify-center bg-white px-6">
        <div className="flex max-w-sm flex-col items-center gap-6 text-center">
          <div className="flex h-16 w-16 items-center justify-center rounded-full bg-gmail-yellow/10">
            <svg
              className="h-8 w-8 text-gmail-yellow"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            >
          ...
          <div>
            <h1 className="text-[22px] font-normal text-foreground">Re-authentication Required</h1>
          ...
          <button
            ...
            className="flex h-10 w-full cursor-pointer items-center justify-center gap-3 rounded-full border border-border bg-white text-sm font-medium text-foreground shadow-sm transition-shadow hover:shadow-md active:bg-surface"
          >
            <GoogleLogo className="h-[18px] w-[18px]" />
            Re-authenticate with Google
          </button>
          <p className="text-xs text-muted">You&apos;ll be redirected back here after signing in</p>
        </div>
      </div>
    );
  }
    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-white px-6">
      <div className="w-full max-w-md">
        <div className="flex flex-col items-center gap-6">
          ...
          <div className="w-full rounded-2xl border border-border bg-white shadow-sm overflow-hidden">
            <div className="border-b border-border px-5 py-4">
              <div className="flex items-center justify-between">
                <div>
                  <h2 className="text-sm font-medium text-foreground">{agentInfo?.agent.name}</h2>
                ...
                <span
                  className={`inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium ${
                    isClaim
                      ...
                      : "bg-gmail-yellow/15 text-gmail-yellow"
                  }`}
                >
              ...
              {displayGrants.length > 0 ? (
                ...
                <p className="text-sm text-muted">
                  {isClaim
                    ...
                    : "This agent is requesting access to your Gmail account. No specific capabilities have been requested yet — they can be granted later."}
                </p>
              )}
            </div>
            ...
            <div className="border-t border-border px-5 py-4">
              {agentInfo?.webauthn?.required && (
                <div className="mb-3 flex items-center gap-2 rounded-xl border border-gmail-yellow/30 bg-gmail-yellow/5 px-3 py-2">
                  <svg
                    className="h-4 w-4 shrink-0 text-gmail-yellow"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
                  ...
                  <p className="text-xs text-gmail-yellow">
              ...
              {actionState === "confirming_deny" ? (
                ...
                <div className="flex gap-3">
                  ...
                  <button
                    ...
                    disabled={actionState !== "idle"}
                    className="flex h-10 flex-1 cursor-pointer items-center justify-center gap-2 rounded-full bg-accent text-sm font-medium text-white transition-all hover:bg-accent/90 active:scale-[0.98] disabled:pointer-events-none disabled:opacity-50"
                  >
          ...
          <p className="text-center text-xs text-muted">Signed in as {session?.user.email}</p>
        </div>
      </div>
    </div>
  );
