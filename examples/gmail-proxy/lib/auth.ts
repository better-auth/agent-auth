...
const capabilities: Capability[] = [
  ...
  },
  {
    ...
    description:
      "List threads with details (subject, from, to, date, snippet, message count, labels). Supports search query filtering and pagination.",
    input: {
      type: "object",
      properties: {
        q: {
