...
function StatusBadge({ status }: { status: string }) {
	const styles: Record<string, string> = {
		...
		denied: "border-gh-danger/40 bg-gh-danger/15 text-gh-danger",
	};
	return (
		<span
...
function EventTypeBadge({ type }: { type: string }) {
	...
	const styles: Record<string, string> = {
		...
		host: "border-gh-done/40 bg-gh-done/15 text-gh-done",
		capability: "border-gh-attention/40 bg-gh-attention/15 text-gh-attention",
		ciba: "border-gh-green-emphasis/40 bg-gh-green-emphasis/15 text-gh-green-emphasis",
	};
	return (
		<span
