...
function makeTool(name: string, overrides?: Partial<AgentAuthTool>): AgentAuthTool {
  return {
    name,
...
const sampleTools: AgentAuthTool[] = [makeTool("alpha"), makeTool("beta"), makeTool("gamma")];
