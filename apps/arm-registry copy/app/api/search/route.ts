...
/**
 * GET /api/search?intent=...&limit=10
 *
 * The core registry endpoint. Returns providers matching a natural-language
 * intent, ranked by relevance. This is what MCP clients call for
 * intent-based discovery (spec SS6.2).
 */
export async function GET(request: Request) {
	...
	const providers: ProviderConfig[] = limited.map((row) => ({
