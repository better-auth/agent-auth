									...
									<div className="flex items-start justify-between gap-4">
										<div className="flex-1 min-w-0">
											<div className="flex items-center gap-2">
												...
												<span className="inline-flex items-center rounded-full border border-gh-attention/40 bg-gh-attention/15 px-2 py-0.5 text-[11px] font-medium text-gh-attention">
													pending
												</span>
											</div>
											{req.binding_message && (
										...
										<div className="flex gap-2 shrink-0">
											<button
												...
												className="cursor-pointer rounded-md bg-gh-green px-3 py-1.5 text-xs font-medium text-white transition-colors hover:bg-gh-green-hover disabled:opacity-50"
											>
											...
											<button
												...
												disabled={acting === req.approval_id}
												className="cursor-pointer rounded-md border border-border bg-surface px-3 py-1.5 text-xs font-medium text-foreground transition-colors hover:border-gh-danger/50 hover:text-gh-danger disabled:opacity-50"
											>
												Deny
											</button>
										</div>
