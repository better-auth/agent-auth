	...
	return (
		<div className="mx-auto w-full max-w-3xl px-6 py-8">
			<div className="flex flex-col gap-8">
				<div>
					<h1 className="font-normal text-[22px] text-foreground">Settings</h1>
				...
				<div className="flex flex-col gap-3">
					...
					<div className="rounded-2xl border border-border bg-white shadow-sm">
						<div className="flex items-center justify-between border-border border-b px-5 py-5">
							...
							<button
								...
								onClick={() =>
									save({ freshSessionEnabled: !settings.freshSessionEnabled })
								}
								role="switch"
								type="button"
							>
						...
						{settings.freshSessionEnabled && (
							<div className="flex items-center justify-between px-5 py-5">
								...
								<div className="flex items-center gap-2">
									<input
										className="w-24 rounded-lg border border-border bg-white px-3 py-1.5 text-right text-foreground text-sm outline-none focus:border-accent focus:ring-1 focus:ring-accent/30"
										max={86_400}
										min={30}
										onBlur={() =>
											save({ freshSessionWindow: settings.freshSessionWindow })
										}
										onChange={(e) =>
											setSettings((s) => ({
												...s!,
